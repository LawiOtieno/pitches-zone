...
def index():
    ...
    forex = Pitch.query.filter_by(category = 'Forex').all()
    religion = Pitch.query.filter_by(category = 'Religion').all()

    return render_template('index.html', pitches = pitches, coding = coding,business = business,forex=forex,religion = religion)  
